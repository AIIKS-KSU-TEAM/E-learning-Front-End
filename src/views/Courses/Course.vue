...
const submitContent = async () => {
  ...
  try {
    await axiosInstance.post(`api/course/courses/${selectedCourse.value}/content/`, form, {
      headers: {
      ...
      <div class="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-lg">
        ...
        <ul class="space-y-4">
          <li v-for="course in courses" :key="course.id"
            ...
            <button @click="openModuleModal(course.id)"
