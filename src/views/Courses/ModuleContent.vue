<template>
  ...
  const loadContents = async () => {
    try {
      const response = await axiosInstance.get(`course/modules/${module_id}/content/`)
  ...
  const saveContent = async () => {
    const url = editing.value
      ? `course/modules/${module_id}/content/${form.value.id}/`
      : `course/modules/${module_id}/content/`
  ...
  const deleteContent = async (contentId) => {
    try {
      await axiosInstance.delete(`course/modules/${module_id}/content/${contentId}/`)
      loadContents()
    } catch (error) {
